...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Semua Data Barang Dikeluarkan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card" class="row-100">
                <div class="card-header">
                    <h3 class="card-title">Seluruh Data Barang Dikeluarkan</h3>
                    <div class="card-tools">
                      <a href="/cetak-belum-ditindak" target="_blank" class="btn btn-secondary mb-2 btn-sm" > <i class="fa fa-print" aria-hidden="true"></i> Cetak</a>
                      <a href="/penindakan" class="btn btn-danger mb-2 btn-sm" > <i class="far fa-arrow-alt-circle-left"></i> Kembali</a>
                    </div>
                </div>
                <div class="card-body">
