  ...
  <body id="top">
    <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" id="navbar">
        <div class="container"><a class="navbar-brand" href="#"><strong>IMADE POM</strong></a>
            ...
            <div class="row no-gutters">
              <div class="col-md-10 col-lg-6 text-center text-md-left margins">
                <div class="white-text">
                  ...
                  <div class="wow fadeInLeft" data-wow-delay="0.3s"><a class="btn btn-white dark-grey-text font-weight-bold ml-0" href="login"><i class="fa fa-play mr-1"></i>Login</a></div>
                </div>
              </div>
            </div>
          </div>
...
<section id="contact" style="background-image:url('img/solid.jpg')">
  <div class="rgba-black-strong py-5">g
    <div class="container">
            ...
            <div class="col-md-4">
              <ul class="list-unstyled text-center">
                ...
                <li class="mt-4"><i class="fa fa-phone indigo-text fa-2x"></i>
                  <p class="mt-2">(0362) 3306355</p>
                </li>
                <li class="mt-4"><i class="fa fa-envelope indigo-text fa-2x"></i>
                  <p class="mt-2">lokapombuleleng@gmail.com</p>
                </li>
              </ul>
            </div>
          </div>
